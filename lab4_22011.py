...
class1_data = pd.read_csv("C:/Users/Pc/Downloads/Bangli-P10_gabor.csv")
class2_data = pd.read_csv("C:/Users/Pc/Downloads/Bangli-P10_gabor.csv")



class1_vectors = class1_data['Gabor1'].values
class2_vectors = class2_data['Gabor32'].values
